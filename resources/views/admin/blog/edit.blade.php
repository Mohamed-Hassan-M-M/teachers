                        ...
                        <div id="html-validations" class="card card-tabs">
                            <div class="card-content">
                                <div class="card-title">
                                    <div class="row">
                                        <div class="col s12 m6 l10">
                                            <h4 class="card-title">@lang('general.update') @lang('general.blog')</h4>
                                        </div>
                                ...
                                <div id="html-view-validations">
                                    <form class="formValidate0" id="formValidate0" action="{{route('admin.blogs.update', $blog->id)}}" method="post" enctype="multipart/form-data">
                                        @method('PUT')
                                        @csrf
                                        <div class="row">
                                            <div class="col s12">
                                                <label for="date">@lang('blog.date')</label>
                                                <input class="@error('date') invalid @enderror " value="{{$blog['date']}}" id="date"
                                                       name="date"
                                                       type="date">
                                            ...
                                            @foreach(['ar', 'en'] as $local)
                                                <div class="input-field col s6">
                                                    ...
                                                    <input @error('title_'.$local)class="invalid" @enderror required value="{{old('title_'.$local, $blog['title_'.$local])}}" id="title_{{$local}}"
                                                           name="title_{{$local}}"
                                                           type="text">
                                                    @error('title_'.$local)
                                                        <span class="red-text" role="alert">
                                            ...
                                            @foreach(['ar', 'en'] as $local)
                                                <div class="input-field col s6">
                                                    ...
                                                    <input @error('description_'.$local)class="invalid" @enderror required value="{{old('description_'.$local, $blog['description_'.$local])}}" id="description_{{$local}}"
                                            ...
                                            <div class="col s12">
                                                <input type="file" id="input-file-now" name="image" class="dropify" data-default-file="{{$blog->image_path}}" data-allowed-file-extensions="jpg jpeg png apng gif avif svg webp" />
                                                @error('image')
                                                <span class="red-text" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
