                        ...
                        <div id="html-validations" class="card card-tabs">
                            <div class="card-content">
                                <div class="card-title">
                                    <div class="row">
                                        <div class="col s12 m6 l10">
                                            <h4 class="card-title">@lang('general.update') @lang('general.student')</h4>
                                        </div>
                                ...
                                <div id="html-view-validations">
                                    <form class="formValidate0" id="formValidate0" action="{{route('admin.students.update', $student->id)}}" method="post" enctype="multipart/form-data">
                                        @method('PUT')
                                        @csrf
                                        <div class="row">
                                            ...
                                            <div class="input-field col s6">
                                                ...
                                                <input @error('mobile')class="invalid" @enderror required value="{{old('username', $student->username)}}" id="username"
                                                       name="username"
                                                       type="text">
                                                @error('username')
                                            ...
                                            <div class="input-field col s6">
                                                ...
                                                <input @error('mobile')class="invalid" @enderror required value="{{old('mobile', $student->mobile)}}" id="mobile"
                                                       name="mobile"
                                                       type="number">
                                                @error('mobile')
                                                <span class="red-text" role="alert">
                                            ...
                                            <div class="input-field col s6">
                                                ...
                                                <input @error('email')class="invalid" @enderror value="{{old('email', $student->email)}}" id="email"
                                                       name="email"
                                                       type="email">
                                                @error('email')
                                                <span class="red-text" role="alert">
