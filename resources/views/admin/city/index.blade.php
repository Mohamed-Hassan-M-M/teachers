        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m6 l6">
                    <h5 class="breadcrumbs-title mt-0 mb-0"><span>@lang('general.module') @lang('general.city')</span>
                    </h5>
                </div>
                        ...
                        <div class="card">
                            <div class="card-content">
                                <div class="mb-4 col s12">
                                    ...
                                    <a class="waves-effect waves-light btn-large col s3" href="{{route('admin.cities.create')}}"><i class="material-icons left">create</i>@lang('general.create') @lang('general.city') @lang('general.new')</a>
                                </div>
                                <div class="row">
                                    <div class="col s12">
                                        <table id="page-length-option" class="display">
                                            ...
                                            @foreach($cities as $index => $city)
                                                <tr>
                                                    ...
                                                    <td class="center">
                                                        <a href="{{route('admin.cities.show',['city'=>$city->id])}}" class="btn blue gradient-shadow white-text tooltipped animated bounceIn m-1"  data-tooltip="@lang('general.show')!"><i class="material-icons">remove_red_eye</i></a>
                                                        <a href="{{route('admin.cities.edit',['city'=>$city->id])}}" class="btn green gradient-shadow white-text tooltipped animated bounceIn m-1"  data-tooltip="@lang('general.edit')!"><i class="material-icons">edit</i></a>
                                                        <form action="{{route('admin.cities.destroy',['city'=>$city->id])}}" method="post" class="m-2 display-inline m-1" type="submit">
