                        ...
                        <div id="html-validations" class="card card-tabs">
                            <div class="card-content">
                                <div class="card-title">
                                    <div class="row">
                                        <div class="col s12 m6 l10">
                                            <h4 class="card-title">@lang('general.update') @lang('general.event')</h4>
                                        </div>
                                ...
                                <div id="html-view-validations">
                                    <form class="formValidate0" id="formValidate0" action="{{route('admin.events.update', $event->id)}}" method="post" enctype="multipart/form-data">
                                        @method('PUT')
                                        @csrf
                                        <div class="row">
                                            <div class="col s6">
                                                ...
                                                <select id="category_id" name="category_id" required>
                                                    <option value="" disabled>@lang('general.choose') @lang('general.cat_event')</option>
                                            ...
                                            <div class="col s6">
                                                ...
                                                <input class="@error('date') invalid @enderror " value="{{$event['date']}}" id="date"
                                                       name="date"
                                                       type="date">
                                                <div class="input-field">
                                                </div>
                                            ...
                                            @foreach(['ar', 'en'] as $local)
                                                <div class="input-field col s6">
                                                    ...
                                                    <input @error('title_'.$local)class="invalid" @enderror required value="{{old('title_'.$local, $event['title_'.$local])}}" id="title_{{$local}}"
                                                           name="title_{{$local}}"
                                                           type="text">
                                                    @error('title_'.$local)
                                                        <span class="red-text" role="alert">
                                            ...
                                            @foreach(['ar', 'en'] as $local)
                                                <div class="input-field col s6">
                                                    ...
                                                    <input @error('description_'.$local)class="invalid" @enderror required value="{{old('description_'.$local, $event['description_'.$local])}}" id="description_{{$local}}"
                                            ...
                                            <div class="col s12">
                                                ...
                                                <div class="input-field">
                                                    <select id="area_id" name="area_id[]" class="select2 browser-default" multiple="multiple" required>
                                                        ...
                                                        @php
                                                            $areasArray = json_encode($event->areas->pluck('id'));
                                                        @endphp
                                            ...
                                            <div class="col s12">
                                                <input type="file" id="input-file-now" name="image" class="dropify" data-default-file="{{$event->image_path}}" data-allowed-file-extensions="jpg jpeg png apng gif avif svg webp" />
                                                @error('image')
                                                <span class="red-text" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
