        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m6 l6">
                    <h5 class="breadcrumbs-title mt-0 mb-0"><span>@lang('general.area') @lang('general.module')</span></h5>
                </div>
                        ...
                        <div id="html-validations" class="card card-tabs">
                            <div class="card-content">
                                <div class="card-title">
                                    <div class="row">
                                        <div class="col s12 m6 l10">
                                            <h4 class="card-title">@lang('general.update') @lang('general.area')</h4>
                                        </div>
                                ...
                                <div id="html-view-validations">
                                    <form class="formValidate0" id="formValidate0" action="{{route('admin.areas.update', $area->id)}}" method="post">
                                        @method('PUT')
                                        @csrf
                                        <div class="row">
                                            <div class="col s12">
                                                ...
                                                <select id="city_id" name="city_id" required>
                                                    ...
                                                    @foreach($cities as $city)
                                                        <option value="{{$city->id}}" @if($area->city->id == $city->id) selected @endif>{{$city->name}}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            @foreach(['ar', 'en'] as $local)
                                                <div class="input-field col s6">
                                                    ...
                                                    <input @error('name_'.$local)class="invalid" @enderror required value="{{old('name_'.$local, $area['name_'.$local])}}" id="name_{{$local}}"
                                                           name="name_{{$local}}"
                                                           type="text">
                                                    @error('name_'.$local)
                                                        <span class="red-text" role="alert">
